/**
 * apps/marketing/src/app/(marketing)/docs/page.tsx
 *
 * Public-facing getting started. Verbatim copy of
 * apps/web/src/app/(marketing)/docs/page.tsx with marketing.module.css
 * import path adjusted and CTA hrefs repointed to the GitHub repo
 * (no /register or /login routes exist on the static marketing site).
 */
...
const STEPS: ReadonlyArray<{
...
}> = [
  {
    ...
    bullets: [
      ...
      { k: "Build", v: "npm run build — compiles packages via tsc -b tsconfig.build.json then bundles apps/api and apps/web." },
      { k: "Optional: desktop", v: "npm --workspace @agentx/desktop run dist:dir to bundle the Electron companion app." },
    ],
  },
  {
    id: "first-run",
    eyebrow: "First run",
    title: "Set your environment and sign in.",
    body:
    ...
    bullets: [
      ...
      { k: "Run the API", v: "node apps/api/dist/server.js — listens on :8787. Run npm --workspace @agentx/web run start after build for :3000." },
  ...
  },
  {
    ...
    bullets: [
      { k: "Marketing site (this site)", v: "apps/marketing — the standalone Next.js project that builds to GitHub Pages." },
      { k: "Full web app", v: "apps/web — the workspace UI: data-tasks, notebook, dashboard, admin panels, CopilotKit runtime." },
  ...
  return (
    <main>
      ...
      <section className={styles.cta}>
        ...
        <div className={styles.heroCtas}>
          <Link
            href="https://github.com/sjkncs/agentx/issues"
            className={styles.buttonPrimary}
          >
            Open an issue →
          </Link>
