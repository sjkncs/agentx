/**
 * apps/web/src/app/(marketing)/features/page.tsx
 *
 * Long-form deep dive, four sections. Each section mirrors the
 * framing real AI-coding-tool sites use (Cursor / Windsurf / Codex):
 *   - What it is in one sentence.
 *   - What you'd do with it today.
 *   - A "show me" sample that points at a real, reachable route or
 *     GET endpoint, never a stub.
 *
 * Server component for first-paint and crawlability. No client JS.
 */
...
const SECTIONS: ReadonlyArray<{
...
}> = [
  {
    ...
    showMe: { href: "/data-tasks", label: "Open the workspace →" },
  },
  {
    id: "skills",
  ...
  },
  {
    ...
    showMe: { href: "/register", label: "Create account to unlock companion mode →" },
  },
  {
    id: "data",
