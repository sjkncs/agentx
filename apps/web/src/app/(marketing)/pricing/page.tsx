 ...
 * actually exist in the repo today, not aspirational SaaS tiers.
 *
 *   1. Community — free, BYO everything, self-hosted.
 *   2. Pro — license key (issueable), advanced skills, priority
 *      security updates. Pricing in the page is illustrative; the
 *      pricing endpoint is intentionally not yet wired.
 *   3. Enterprise — SSO + audit log + custom data policies.
 *
 * Every CTA links to /register (single-machine install) — the only
 * currently-real onboarding path.
 */
